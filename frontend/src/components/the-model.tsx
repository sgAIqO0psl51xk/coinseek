...
const MetaIcon = () => (
    <div className="relative" >
        <Image src="https://artificialanalysis.ai/img/logos/meta_small.svg" alt="Meta" height={20} width={20} />
...
const MistralIcon = () => (
    <div className="relative" >
        <Image src="https://artificialanalysis.ai/img/logos/mistral_small.png" alt="Mistral" height={20} width={20} />
        <div className="absolute left-1/2 top-1/2 h-0.5 w-[140%] -translate-x-1/2 -rotate-45 bg-foreground" />
    </div>
);
...
const OpenAIIcon = () => (
    <div className="relative" >
        <Image src="https://artificialanalysis.ai/img/logos/openai_small.svg" alt="OpenAI" height={20} width={20} />
        <div className="absolute left-1/2 top-1/2 h-0.5 w-[140%] -translate-x-1/2 -rotate-45 bg-foreground" />
    </div>
);
...
const GoogleIcon = () => (
    <div className="relative" >
        <Image src="https://artificialanalysis.ai/img/logos/google_small.svg" alt="Google" height={20} width={20} />
        <div className="absolute left-1/2 top-1/2 h-0.5 w-[140%] -translate-x-1/2 -rotate-45 bg-foreground" />
    </div>
);
...
const AnthropicIcon = () => (
    <div className="relative" >
        <Image src="https://custom.typingmind.com/assets/models/claude.webp" alt="Anthropic" height={20} width={20} />
        <div className="absolute left-1/2 top-1/2 h-0.5 w-[140%] -translate-x-1/2 -rotate-45 bg-foreground" />
    </div>
);
...
const AzureIcon = (
    ...
    <div className="relative" >
        <Image src="https://custom.typingmind.com/assets/models/azureopenai.png" alt="Azure" {...props} height={20} width={20} />
        <div className="absolute left-1/2 top-1/2 h-0.5 w-[140%] -translate-x-1/2 -rotate-45 bg-foreground" />
    </div>
);

const MODEL_ICONS = [
    { icon: AnthropicIcon, position: "left-3", size: "small", iconSize: "small", className: "hidden lg:flex" },
    ...
    { icon: AzureIcon, position: "right-3", size: "small", iconSize: "small", className: "hidden lg:flex" }
];
...
const Integration = () => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center w-full py-20" id="the-model">
            ...
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto lg:absolute lg:top-1/4 inset-x-0 mt-12 lg:mt-0">
            ...
            <Container delay={0.3}>
                <div className="relative hidden lg:flex items-center justify-center overflow-visible">
                    ...
                    <div className="absolute z-20 flex items-center justify-center group">
                        <Image src="https://custom.typingmind.com/assets/models/deepseek.png"
                            alt="DeepSeek"
                            width={100}
                            height={100}
