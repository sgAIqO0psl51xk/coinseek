...
#             if a telegram portal exists for the coin, that's usually a positive signal,
#             though it's also not too much of an issue if it doesn't
...
#     async def run_llm_analysis(self, messages: List[Dict[str, str]]) -> AsyncGenerator:
